<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/master/main.master" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="update" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Scripts" runat="server">
    <script type="text/javascript">
        ...
        function songOk(e) {
            ...
            hasSong = true;
            $Div("conversion").Collapsed(false);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <daiz:Section ID="Section2" runat="server" HeaderText="First Measure *">
    ...
    <daiz:Section ID="Section1" runat="server">
        <daiz:Subsection HeaderText="Modifying Your Edit " ID="headertitle" runat="server">
            <p>You only need to upload a new simfile if you're modifying the actual step data. All other
            modifications under "Edit Information" can be made without submiting a new simfile.</p>
            <p>Fields marked with a * will cause the edit to have a new .DAT file once the edit is saved. Fields
            without a * is just information stored for site purposes.</p>
        </daiz:Subsection>
        <daiz:Subsection ID="Subsection1" HeaderText="Simfile" runat="server">
            <table highlight="formh" width="100%" class="form">
                <colgroup>
                    <col width="200" align="right" />
                </colgroup>
                <tr>
                    <td>* Upload New Simfile</td>
        ...
        <daiz:Subsection HeaderText="Conversion Information" runat="server">
            <table highlight="formh" width="100%" class="form">
                ...
                <tr>
                    <td>* Song ID</td>
                    <td><span id="song_ok" class="error">No song selected.</span></td>
                </tr>
                <tr>
                    <td>* Select Chart</td>
                    <td>
        ...
        <daiz:Subsection ID="Subsection3" HeaderText="Edit Information" runat="server">
            <table highlight="formh" width="100%" class="form">
                <colgroup>
                ...
                <tr>
                    <td>Edit Name</td>
                    <td>
                    <asp:TextBox ID="TxtName" MaxLength="8" runat="server" />
                    <daiz:Validator ID="Validator1" runat="server" Required="true">Name required.</daiz:Validator>
                ...
                <tr>
                    <td>Notes</td>
                    <td><asp:TextBox ID="TxtNotes" runat="server" TextMode="MultiLine" Rows="5" Columns="50" /></td>
                </tr>
                <tr>
                    <td>Video URL</td>
                    <td><daiz:TextBox Size="75" ID="video" runat="server" /></td>
                </tr>
                <tr class="formfooter">
                    <td></td>
                    <td>
