...
function Canvas(e) {
    if (e === undefined || e.Type == Type.String) {
        e = NinJa.CreateElement(e, "canvas");
    }
    var $ = this;
    $.DOM = e;
    e.$ = $;
...
Canvas.prototype.Width = Element.prototype.Width;
Canvas.prototype.Height = Element.prototype.Height;
...
Canvas.prototype.DrawImageStretch = function (image, sourceReg, destReg) {
    this.Context.drawImage(image, sourceReg.X, sourceReg.Y, sourceReg.Width, sourceReg.Height, destReg.X, destReg.Y, destReg.Width, destReg.Height);
    return this;
}
