...
Validator.prototype.Validate = function () {
    ...
    if (this.Enabled && disp) {
        ...
        if (this.__Function) {
            //if (t != 0) {
            if (this.__Function.apply(window, [this.Element]) === false) {
                this.Collapsed(false);
                this.LastValidationResult = false;
                return false;
            }
...
function prevSibling(e) {
    ...
    if (e.parentNode) {
        var i, c = e.parentNode.children, i, v, l = c.length;
        for (i = 0; i < l; i++) {
            if (c[i] == e) {
                if (i == 0) { return null; }
                return c[i - 1].$;
